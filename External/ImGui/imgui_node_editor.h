...
{
    std::size_t operator()(const ax::NodeEditor::NodeId& id) const
    {
...
{
    std::size_t operator()(const ax::NodeEditor::LinkId& id) const
    {
        return std::hash<uintptr_t>{}(id.Get());
    }
};
...
{
    std::size_t operator()(const ax::NodeEditor::PinId& id) const
    {
        return std::hash<uintptr_t>{}(id.Get());
    }
};
